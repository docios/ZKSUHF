 ...
 */
public class CustomDateHourPicker {
    ...
    public CustomDateHourPicker(Context context, ResultHandler resultHandler, String startDate, String endDate) {
